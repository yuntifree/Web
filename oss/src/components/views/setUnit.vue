        ...
        <div class="edit-form">
          ...
          <el-form ref="form" :model="postInfo" :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="地址" prop="address">
              <el-input  v-model.trim="postInfo.address" placeholder="请输入地址"></el-input>
            </el-form-item> 
            <el-form-item label="经度" prop="longitude">
              <el-input  v-model.trim="postInfo.longitude" placeholder="请输入地址"></el-input>
            </el-form-item>
            <el-form-item label="纬度" prop="latitude">
              <el-input  v-model.trim="postInfo.latitude" placeholder="请输入地址"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    getData(reload) {
      ...
      CGI.post(this.$store.state, 'get_unit', param, (resp) => {
        if (resp.errno === 0) {
          var data = resp.data;
          if (data.infos) {
